...
try{
  ...
  const reason=['government_key_missing','collection_page_limit','upstream_request_failed','upstream_invalid_response','upstream_incomplete_page'].includes(error.message)?error.message:'collection_failed';
